...
function Admin() {
  ...
  const deleteProduct = async(trenutniId) => {
    ...
    const result = await axios.post('http://localhost:5000/deleteProduct', {korisnik,trenutniId})
  ...
  const toggleForm = () => {
    ...
    // const korisnik = JSON.parse(localStorage.getItem('user'))
    // const result = await axios.post('http://localhost:5000/updateProduct', {korisnik,updateItem})
  ...
  const updateItem = async (itemId) => {
    ...
    const result = await axios.post('http://localhost:5000/updateProduct',{itemId,updateProd})
  ...
  const onSubmit = async (e) => {
    e.preventDefault()
    const result = await axios.post('http://localhost:5000/addProduct', product)
